...
import paymentStructureRoutes from "./routes/paymentStructureRoutes.js";
import chapterAssignmentRoutes from "./routes/chapterAssignmentRoutes.js";
...
app.use("/api/payment-structures", paymentStructureRoutes);
app.use("/api/chapter-assignments", chapterAssignmentRoutes);
